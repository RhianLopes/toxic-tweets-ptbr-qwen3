...
OUTPUT = ROOT / "results" / "full" / "zero_shot_v2_descriptions.csv"
...
CATEGORIES = """
- NOT_TOXIC: comentário neutro ou positivo, sem conteúdo ofensivo.
- OBSCENE: linguagem chula, palavrões ou conteúdo sexualmente explícito.
- INSULT: ataque pessoal direto, xingamento ou humilhação a indivíduo.
- HOMOPHOBIA: discurso de ódio ou discriminação contra pessoas LGBTQIA+.
- RACISM: discurso de ódio ou discriminação racial ou étnica.
- MISOGYNY: discurso de ódio ou discriminação contra mulheres.
- XENOPHOBIA: discurso de ódio contra pessoas de outras regiões ou nacionalidades.
"""
